// Plazma port — purple palette application (generated: palette body is a
// verbatim copy of dev/plazma/theme/plazma-purple.colors.txt).
...
// Full palette override in tdesktop's colors.palette format. Unspecified keys
// fall back to the built-in defaults, so a partial list is fine.
const char kPurplePalette[] = R"PLAZMA(
windowBg: #191426; // white: fallback for background
windowFg: #f5f5f5; // black: fallback for text
windowBgOver: #241d38; // light gray: fallback for background with mouse over
windowBgRipple: #271f3d; // darker gray: fallback for ripple effect
windowFgOver: #e9ecf0; // black: fallback for text with mouse over
windowSubTextFg: #708499; // gray: fallback for additional text
windowSubTextFgOver: #7c90a4; // darker gray: fallback for additional text with mouse over
...
windowBgActive: #8a63d2; // bright blue: fallback for blue filled active areas
windowFgActive: #ffffff; // white: fallback for text on active areas
windowActiveTextFg: #ab8bf0; // online blue: fallback for active text like online status
...
activeButtonBg: #6d44b8; // default active button background
activeButtonBgOver: #7a4fc7; // default active button background with mouse over
activeButtonBgRipple: #8155cf; // default active button ripple effect
activeButtonFg: #ffffff; // default active button text
activeButtonFgOver: #ffffff; // default active button text with mouse over
activeButtonSecondaryFg: #c9b6f0; // default active button additional text (selected messages counter in forward / delete buttons)
activeButtonSecondaryFgOver: activeButtonSecondaryFg; // default active button additional text with mouse over
activeLineFg: #9670e0; // default active line (like code input field bottom border when you log in and field is focused)
...
lightButtonBg: #17212b; // default light button background (like buttons in boxes)
lightButtonBgOver: #1d2a39; // default light button background with mouse over
lightButtonBgRipple: #223143; // default light button ripple effect
lightButtonFg: #6ab2f2; // default light button text
...
menuBg: #17212b; // default popup menu background
...
placeholderFg: #6d7883; // default input field placeholder when field is not focused (like in phone input field when you log in)
...
filterInputBorderFg: #242f3d; // default rounded input field border (like in chats list search field when field is focused)
filterInputInactiveBg: #242f3d; // default rounded input field background (like in chats list search field when field is inactive)
checkboxFg: #6a5a86; // default unchecked checkbox rounded rectangle (and also emoji category icons)
...
tooltipBg: #16222d; // tooltip background (like when you put mouse over the message timestamp and wait)
tooltipFg: #d4e0ea; // tooltip text
tooltipBorderFg: #16222d; // tooltip border
titleShadow: #00000000; // one pixel line shadow at the bottom of custom window title
titleBg: #1d1730; // custom window title background when window is inactive
titleBgActive: #242f3d; // custom window title background when window is active
...
titleButtonBgActive: #242f3d; // custom window title minimize/maximize/restore button background when window is active (Windows only)
...
titleButtonCloseBgActive: #242f3d; // custom window title close button background when window is active (Windows only)
...
boxBg: #17212b; // box background
boxTextFg: windowFg; // box text
boxTextFgGood: #5598db; // accepted box text (like when choosing username that is not occupied)
boxTextFgError: #dc3d3d; // rejecting box text (like when choosing username that is occupied)
boxTitleFg: #ebebeb; // box title text
boxSearchBg: #17212b; // box search field background (like in contacts box)
...
contactsBg: #17212b; // contacts (and some other) box row background
contactsBgOver: #1f2c39; // contacts (and some other) box row background with mouse over
...
callArrowMissedFg: #ed5050; // missed phone call arrow (in calls list box)
introBg: windowBg; // login background
introTitleFg: #eeeeee; // login title text
introDescriptionFg: #72879b; // login description text
introErrorFg: #e94040; // login error text (like when providing a wrong log in code)
...
dialogsVerifiedIconFg: #17212b; // chat list verified icon check
...
dialogsBgOver: #221b34; // chat list background with mouse over
...
dialogsBgActive: #3d2f66; // chat list background for current (active) chat
...
searchedBarBg: #202b38; // search results bar background (in chats list, contacts box..)
searchedBarFg: #8c98a4; // search results bar text (in chats list, contacts box..)
topBarBg: #17212b; // top bar background (in chat view, media overview..)
emojiPanBg: windowBg; // emoji panel background
emojiPanCategories: #17212b; // emoji panel categories background
...
msgServiceBg: #213040d5; // service message background (like in a service message about group title being changed) (adjusted)
...
historyFileOutIconFg: #ffffff; // outbox file without thumbnail (like audio file) download arrow icon
historyFileOutIconFgSelected: #ffffff; // outbox selected file without thumbnail (like audio file) download arrow icon
...
historyComposeAreaBg: #17212b; // history compose area background (message write area / reply information / forwarding information)
...
historyPinnedBg: #1b2734; // pinned message area background
...
filterInputActiveBg: #2a2440; // default rounded input field active background (like in chats list search field when field is focused)
botKbBg: #242f3d; // bot keyboard button background
...
sideBarBg: #170f26; // filters side bar background
sideBarBgActive: #2c2340; // filters side bar active background
sideBarBgRipple: #241a38; // filters side bar ripple effect
...
void ApplyPlazmaPurpleTheme() {
	...
	const auto content = QByteArray::fromRawData(
		kPurplePalette,
		int(sizeof(kPurplePalette) - 1));
	if (Window::Theme::ApplyEditedPalette(content)) {
		applied = true;
	}
}
